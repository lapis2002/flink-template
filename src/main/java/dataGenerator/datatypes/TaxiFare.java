...
public class TaxiFare implements Serializable {
    ...
    private Instant startTime;   // the start time for this ride
    private String paymentType;  // CASH or CARD
    private float tip;           // tip for this ride
    private float tolls;         // tolls for this ride
    private float totalFare;     // total fare collected
