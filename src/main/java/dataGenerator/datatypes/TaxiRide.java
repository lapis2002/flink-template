...
import dataGenerator.utils.DataGenerator;
...
public class TaxiRide implements Comparable<TaxiRide>, Serializable {
    ...
    private long rideId;         // a unique id for each ride
    private boolean isStart;     // TRUE for ride start events, FALSE for ride end events
    private Instant eventTime;   // the timestamp for this event
    private float startLon;      // the longitude of the ride start locatio
    private float startLat;      // the latitude of the ride start location
    private float endLon;        // the longitude of the ride end location
    private float endLat;        // the latitude of the ride end location
    private short passengerCnt;  // number of passengers on the ride
    private long taxiId;         // a unique id for each taxi
    private long driverId;       // a unique id for each driver
